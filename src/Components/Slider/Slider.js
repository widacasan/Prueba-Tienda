    ...
    <div>
      <Slider {...settings}>
        ...
        <Slide
          ...
          onDetailsClick={() =>
            handleDetailsClick(
              "¡Descubre el futuro de la tecnología con nuestra increíble oferta en Tablets Táctiles! Sumérgete en una experiencia digital sin límites con nuestra tablet de última generación. Su pantalla táctil de alta resolución ofrece colores vibrantes y detalles nítidos."
            )
          }
        />
      </Slider>
      ...
      <div className="product-description">
        {currentProductDescription && <p>{currentProductDescription}</p>}
      </div>
    </div>
  );
};
